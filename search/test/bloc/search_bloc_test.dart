...
void main() {
  ...
  group('Search Movies', () {
    blocTest<SearchBloc, BlocState>(
      ...
      act: (bloc) =>
          bloc.add(const OnQueryChanged(tQuery, CategoryMovie.Movies)),
    ...
    blocTest<SearchBloc, BlocState>(
      ...
      act: (bloc) => {bloc.add(const OnResetData())},
  ...
  group('Search TV Series', () {
    blocTest<SearchBloc, BlocState>(
      ...
      act: (bloc) =>
          bloc.add(const OnQueryChanged(tQuery2, CategoryMovie.TvSeries)),
      wait: const Duration(milliseconds: 500),
      expect: () => [
        StateLoading(),
